  ...
  return (
    <Link to={`/teams/${team.id}`}>
      ...
      >
        ...
        <div className="w-24 h-24 bg-dark-900 rounded-2xl mb-4 flex items-center justify-center overflow-hidden ring-1 ring-white/10 transition-all shadow-xl relative z-10 group-hover:shadow-[0_0_20px_var(--hover-color)] group-hover:ring-[var(--hover-color)]">
          <EntityLogo
            src={team.logotype}
            alt={team.fullname}
            fallback={team.shortname?.[0] || '?'}
